...
def linify(
    ...
    for colour in range(0, 2):
        ...
        for i in range(1, img.shape[0]):
            # lean = -lean
            display_percentage(
                "running linify for colour %s... " % colour_map[colour], i, img.shape[0]
            )
            for j in range(0, number_of_lines):
                ...
                if left_only:
                    if (
                        gradient_array[
                            i, wrap(img_width - 1, previous_positions[j]), colour
                        ]
                        - gradient_array[
                            i, wrap(img_width - 1, previous_positions[j] - 1), colour
                        ]
                        > lean
                    ):
                        direction = 1
                    ...
                    if straight_only:
                        gradient_direction = gradient_array[
                            ...
                            gradient_array[
                                i,
                                wrap(img_width - 1, previous_positions[j] - 1),
                                colour,
                            ]
                        )
                ...
                if separate_colours:
                    new_img[
                        i, wrap(img_width, previous_positions[j] + direction), colour
                    ] = img[
                        i, wrap(img_width, previous_positions[j] + direction), colour
                    ]
                else:
                    if straight_only:
                        new_img[
                            i, wrap(img_width, previous_positions[j] + direction), 0
                        ] = img[
                            i, wrap(img_width, previous_positions[j] + direction), 0
                        ]
                        new_img[
                            i, wrap(img_width, previous_positions[j] + direction), 1
                        ] = img[
                            i, wrap(img_width, previous_positions[j] + direction), 1
                        ]
                        new_img[
                            i, wrap(img_width, previous_positions[j] + direction), 2
                        ] = img[
                            i, wrap(img_width, previous_positions[j] + direction), 2
                        ]
                    else:
                ...
                if (
                    allow_line_merging
                    or previous_positions[wrap(number_of_lines - 1, j + 1)]
